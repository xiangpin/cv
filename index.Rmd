...
![logo](xushuangbin.jpg){width=100%}

```{r}
# When in export mode the little dots are unaligned, so fix that. 
#if(PDF_EXPORT){
#  cat("View this CV online with links at _xiangpin.github.io/cv_")
#}
```
...
- <i class="fa fa-envelope"></i> xshuangbin@163.com
- <i class="fa fa-github"></i> [github.com/xiangpin](http://github.com/xiangpin)
- <i class="fa fa-weixin"></i> BT开发者 (公众号)
- <i class="fa fa-phone"></i> (86) 13860419424
...
Shuangbin Xu (徐双斌) {#title}
--------------------------------------------------------------------------------

A Ph.D. student of Bioinformatics, I am broadly interested in metagenomics, bioinformatics, machine learning, data mining and visualization.


```{r, results='asis'}
intro_text <- glue("I have leaded or contributed to developing some R packages, including ",
  {Biocpkg("MicrobiotaProcess")}, ", ", 
  {Biocpkg("ggtreeExtra")}, ", ",
  {CRANpkg("ggstar")}, ", ",
  {CRANpkg("ggbreak")}, ", ", 
  {Biocpkg("ggtree")}, ", " , 
  {Biocpkg("treeio")}, ", " ,
  {CRANpkg("tidytree")}, " and " ,
  {Biocpkg("ggmsa")},
  ", to help related researchers to explore and understand their data.")
...
```{r, echo = FALSE}
print_section(position_data, 'firstAuthor')
```
...
```{r, echo = FALSE}
print_section(position_data, 'coAuthor')
```

Awards {data-icon=crown}
--------------------------------------------------------------------------------
